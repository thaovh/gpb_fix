# =====================================================
# Script: Run Ward Migration (PowerShell)
# Description: Chạy migration script để tạo bảng BML_WARDS
# Author: LIS GPB Team
# Date: 2024-01-15
# Version: 1.0
# =====================================================
...
Write-Host "LIS GPB - Ward Migration Script" -ForegroundColor Cyan
Write-Host "=====================================================" -ForegroundColor Cyan
Write-Host ""
...
$scriptPath = Join-Path $PSScriptRoot "create-bml-wards-table.sql"
...
try {
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        Write-Host "=====================================================" -ForegroundColor Green
        Write-Host ""
        Write-Host "Table BML_WARDS has been created with sample data." -ForegroundColor White
        Write-Host "You can now use the Ward API endpoints." -ForegroundColor White
        Write-Host ""
    } else {
        Write-Host ""
