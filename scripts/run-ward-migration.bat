@echo off
REM =====================================================
REM Script: Run Ward Migration
REM Description: Chạy migration script để tạo bảng BML_WARDS
...
echo =====================================================
echo LIS GPB - Ward Migration Script
echo =====================================================
echo.
...
sqlplus %ORACLE_USERNAME%/%ORACLE_PASSWORD%@%ORACLE_HOST%:%ORACLE_PORT%/%ORACLE_SERVICE% @create-bml-wards-table.sql
...
if %errorlevel% equ 0 (
    ...
    echo =====================================================
    echo.
    echo Table BML_WARDS has been created with sample data.
    echo You can now use the Ward API endpoints.
    echo.
) else (
    echo.
    echo =====================================================
