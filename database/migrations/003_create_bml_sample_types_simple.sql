-- Migration: 003_create_bml_sample_types_simple.sql
-- Create BML_SAMPLE_TYPES table for Sample Type module

-- Drop table if exists (ignore error if not exists)
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE BML_SAMPLE_TYPES CASCADE CONSTRAINTS';
EXCEPTION
    WHEN OTHERS THEN
        IF SQLCODE != -942 THEN
            RAISE;
...
PROMPT 'BML_SAMPLE_TYPES table created successfully with sample data';
