...
-- Create indexes
CREATE INDEX IDX_BML_SAMPLE_TYPES_TYPE_CODE ON BML_SAMPLE_TYPES(TYPE_CODE);
CREATE INDEX IDX_BML_SAMPLE_TYPES_TYPE_NAME ON BML_SAMPLE_TYPES(TYPE_NAME);
CREATE INDEX IDX_BML_SAMPLE_TYPES_SORT_ORDER ON BML_SAMPLE_TYPES(SORT_ORDER);
CREATE INDEX IDX_BML_SAMPLE_TYPES_CREATED_AT ON BML_SAMPLE_TYPES(CREATED_AT);
